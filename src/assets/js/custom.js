...
$(document).ready(function() {
    ...
    $(document).bind('click',function(e){
        ...
        $SIDEBAR_MENU.find('ul ul.child_menu').stop().slideUp();
        e.stopPropagation();
    });
    $SIDEBAR_MENU.find('a.no-child').off('click').on('click',function(ev){
        var $li = $(this).parent();
        $li.siblings().removeClass('active active-sm').children('ul').stop().slideUp();
    });
    $SIDEBAR_MENU.find('a').not('.no-child').off('click').on('click', function(ev) {
        var $li = $(this).parent();
        if ($li.is('.active')) {
